...
public class ApiRequest_test extends TestCase {

  private static Logger m_log = Config.getLogger(ApiRequest_test.class);

  public ApiRequest_test(String sName) {
    super(sName);
  }
  ...
  public void test_Store() {
    ...
    try {
      ...
      entity.setMaxWait(new Integer(1));
      entity.setLastUpdated(Util.getCurrentDate());
      entity.setDateCreated(Util.getCurrentDate());
      entity.setApiRequestKey(new Long(123));
      entity.setVersion("test");
      entity.setRequest("test");
      ...
      entity.setMaxWait(new Integer(1213));
      entity.setLastUpdated(Util.getCurrentDate());
      entity.setDateCreated(Util.getCurrentDate());
      entity.setApiRequestKey(new Long(123523));
      entity.setVersion("235test");
      entity.setRequest("235test");
      entity.save();
      assertTrue(true);
  ...
  public static Test suite() {
    return new TestSuite(ApiRequest_test.class);
  }
