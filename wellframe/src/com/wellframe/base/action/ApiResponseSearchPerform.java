...
public class ApiResponseSearchPerform extends SecureAction {

   private static Logger m_log = Config.getLogger(ApiResponseSearchPerform.class);
   ...
   public ActionForward process(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
      ...
      orderBy.setField(apiResponse.getPKName());
      orderBy.setOrderType(SearchOrderBy.SEARCH_ORDER_TYPE_ASC);
      searchInfo.addSearchOrderBy(orderBy);

      Vector results = apiResponse.findBySearchInfo(searchInfo);
