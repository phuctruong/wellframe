...
////--%>
<%@ include file="../_java/Dao/Dao_list.java" %>
...
<LI> <merge:token token="search_results_id" replaceText="search_info"><A HREF="Dao_search.jsp?search_info">Modify Search</A></merge:token>
</UL>
...
<%-- //// ============================= FILE =======================================
    ...
    ///   <token name="documentServlet" replaceText="../DocumentServlet" />
      ...
      <A HREF="../DocumentServlet/FileId.FileExtension" target="new_window">FileName</A>
      </Dao:display>
      </Dao:display>
      </Dao:display>
      </TD>
...
<%-- //// ============================= ACTION LINKS =======================================    
    ...
    ////--%>
      ...
      <merge:token token="search_results_id" replaceText="search_info">
