...
////--%>
<%@ include file="../_java/Dao/Dao_edit.java" %>
...
<FORM ACTION="Dao_edit.jsp" NAME="form" METHOD="post" ENCTYPE="multipart/form-data">
<%-- ////
...
//// --%>
    <TR valign="top">
      ...
      <TD class="tableContent">
      <Dao:edit id="Dao" property="VectorValue" selectOptionsList="Dao">
      <SELECT NAME="test">
      <OPTION>MA
      <OPTION>CA
      </SELECT>
...
//// --%>
    <TR valign="top">
      ...
      <TD class="tableContent">
      <Dao:edit id="Dao" property="ForeignVector" selectOptionsList="Dao">
      <SELECT NAME="test">
      <OPTION>MA
      <OPTION>CA
      </SELECT>
