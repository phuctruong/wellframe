...
<%@ include file="../_java/Dao/Dao_search.jsp" %>
...
//// --%>
    <TR VALIGN="top">
      ...
      <TD class="tableContent">
      <Dao:search id="Dao" property="BooleanValue" searchType="exact">
...
//// --%>
    <TR VALIGN="top">
      ...
      <TD class="tableContent">
      <Dao:search id="Dao" property="VectorValue" searchType="multipleOr" >
      <SELECT NAME="test">
      <OPTION>MA
      <OPTION>CA
      </SELECT>
...
//// --%>
    <TR VALIGN="top">
      ...
      <TD class="tableContent">
      <Dao:search id="Dao" property="ForeignVector" searchType="multipleOr" >
      <SELECT NAME="test">
      <OPTION>MA
      <OPTION>CA
      </SELECT>
